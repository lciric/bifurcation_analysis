function  [UserInfo,pvec,syshandle,RHShandle]=start_analyse_Lazar(path,folder,nb_variable)
    ...
    SubFunHandles=feval(syshandle); %Zerlaut_adap %Get function handles from system file
    RHShandle=SubFunHandles{2};  %@fun_eval    %Get function handle for ODE
    ...
    %p_exc_AB=parameter.p_exc_AB;
    %p_exc_BA=parameter.p_exc_BA;
    %p_inh_AB=parameter.p_inh_AB;
    %p_inh_BA=parameter.p_inh_BA;
    %g=parameter.g;
    %T=parameter.T;
    external_input_E_E= 0.% 1.389995245736951e-08 %middle fp 6368  %2.269354939363481e-04 %HOPF 
    ...
    cond_variable = [
        ...
        'Boundary_up_p_exc_AB','Boundary_low_p_exc_AB',...
        'Boundary_up_p_exc_BA','Boundary_low_p_exc_BA',...
        'Boundary_up_p_inh_AB','Boundary_low_p_inh_AB',...
        'Boundary_up_p_inh_BA','Boundary_low_p_inh_BA',... 
    ...
    UserInfo = [
        struct('name', 'Boundary_up_v_eA' ,'label', 'BV', 'state', 1.0),...
        struct('name', 'Boundary_low_v_eA' ,'label', 'BV', 'state', 1.0),...
        struct('name', 'Boundary_up_v_eB' ,'label', 'BV', 'state', 1.0),...
        struct('name', 'Boundary_low_v_eB' ,'label', 'BV', 'state', 1.0),...
        struct('name', 'Boundary_up_v_iA' ,'label', 'BV', 'state', 1.0),...
        struct('name', 'Boundary_low_v_iA' ,'label', 'BV', 'state', 1.0),...
        struct('name', 'Boundary_up_v_iB' ,'label', 'BV', 'state', 1.0),...
        struct('name', 'Boundary_low_v_iB' ,'label', 'BV', 'state', 1.0),...
        struct('name', 'Boundary_up_w_eA' ,'label', 'BV', 'state', 1.0),...
        struct('name', 'Boundary_low_w_eA' ,'label', 'BV', 'state', 1.0),...
        struct('name', 'Boundary_up_w_eB' ,'label', 'BV', 'state', 1.0),...
        struct('name', 'Boundary_low_w_eB' ,'label', 'BV', 'state', 1.0),...
        ];
    %%%§§§§§§§§§!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    pvec=[
        ...
        g,T,external_input_E_E,external_input_E_I,P_e_0,P_e_1,...
        P_e_2,P_e_3,P_e_4,P_e_5,P_e_6,...
        P_e_7,P_e_8,P_e_9,P_i_0,P_i_1,...
        P_i_2,P_i_3,P_i_4,P_i_5,P_i_6,...
        P_i_7,P_i_8,P_i_9
